...
- **添加双击左侧屏幕快退、中间屏幕播放暂停、右侧屏幕快进；左侧上下滑调亮度，右侧上下滑调音量**
## 9527.007
- **播放器里的设置弹窗改为右侧边栏**
- **片头尾可按当前播放时间设置，也可按分和秒自定义**
- **画质改为网格，音轨和字幕改为卡片列表**
## 9527.008
- **弹幕设置体验优化**
- **播放器播放等待加载中体验优化**
- **字幕选择列表优先显示中文名称**
- **片头尾设置优化，检测到片尾后先提示，三秒后再跳过**
- **进度条上用小竖线标出片头和片尾**
- **右上角菜单增加定时关闭，到点退出当前播放**
- **返回桌面后应用留在后台，再次进入保留登录和当前页面**
- **添加手动刷新，手机端支持下拉刷新，TV端点击刷新按钮刷新**
